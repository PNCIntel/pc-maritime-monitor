...
st.set_page_config(page_title="P&C Intelligence — Security Test", layout="wide")
...
st.caption("Security product test — same canonical P&C data, security-focused presentation")
